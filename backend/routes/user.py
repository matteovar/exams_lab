...
def registrar_usuario():
    ...
    usuario_collection.insert_one(
        {"nome": nome, "cpf": cpf, "senha": hashed, "tipo": tipo}  # <-- SALVA O TIPO
    )
...
def login():
    ...
    cpf = data.get("cpf")
    senha = data.get("senha")
    tipo = data.get("tipo")  # "medico" ou "usuario"
    ...
    access_token = create_access_token(identity={"cpf": cpf, "tipo": tipo})
