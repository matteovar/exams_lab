...
const PainelColeta = () => {
  ...
  const [todosExamesConcluidos, setTodosExamesConcluidos] = useState(false);
  ...
  // Checar se todos os exames estão concluídos
  useEffect(() => {
    const todasConcluidas = coletasPendentes.every(coleta =>
      coleta.exames.every(exame => exame.concluido)
    );

    setTodosExamesConcluidos(todasConcluidas);
    ...
    <>
      ...
      <div className="p-4 max-w-6xl mx-auto">
        ...
        {loading ? (
          ...
          <>
            {todosExamesConcluidos && (
              <div className="bg-green-100 text-green-800 p-4 rounded-lg shadow text-center mb-4">
                Paciente concluiu todos os exames!
              </div>
            )}
