...
import { User, Mail, Lock, Phone, IdCard, Stethoscope } from "lucide-react";
...
const CadastroMedico = () => {
  ...
  const handleCadastro = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:5000/api/usuario/register-medico", {
        method: "POST",
        headers: {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-100 via-white to-blue-200 px-4">
      <div className="bg-white p-10 rounded-2xl shadow-xl w-full max-w-xl mb-16">
        <h2 className="text-3xl font-semibold text-gray-800 text-center mb-8">Cadastro de Médico</h2>
